...
class KnowledgesControllerTest < ActionController::TestCase
  ...
  test "should create knowledge" do
    assert_difference('Knowledge.count') do
      post :create, knowledge: { description: @knowledge.description, file: @knowledge.file, show_name: @knowledge.show_name, tag_id: @knowledge.tag_id }
    end
  ...
  test "should update knowledge" do
    patch :update, id: @knowledge, knowledge: { description: @knowledge.description, file: @knowledge.file, show_name: @knowledge.show_name, tag_id: @knowledge.tag_id }
    assert_redirected_to knowledge_path(assigns(:knowledge))
  end
